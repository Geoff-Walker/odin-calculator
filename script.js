class Calulator {
	...
	updateDisplay() {
		...
		if (this.operation != null) {
			this.previousOperandTextElement.textContent = `${this.getDisplayNumber(this.previousOperand)} ${this
				.operation}`;
		} else {
...
function handleKeyboardInput(e) {
	...
	if (e.key === '+' || e.key === '-' || e.key === '*' || e.key === '/')
		calculator.chooseOperation(convertOperator(e.key)), calculator.updateDisplay();
}
